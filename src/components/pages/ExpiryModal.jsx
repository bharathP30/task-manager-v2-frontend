export default function ExpiryModal ({ onclick }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            ...
            <div
         className='w-fit flex flex-col justify-end items-center gap-12 px-8 py-16  font-sans text-center text-white border rounded-lg bg-black/70 border-white/20 backdrop-blur-lg shadow shadow-red-500 md:max-w-2xl md:px-12 md:py-24'>
