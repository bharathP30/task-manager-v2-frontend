export default function Header ({ setIsWantToLogout }) {
  return (
    <>
      <div className='flex items-center justify-between w-full mx-auto md:max-w-2xl'>
      <h1 className="flex-1 my-6 font-sans text-2xl font-semibold text-white/80 md:text-4xl md:my-12">Task Manager</h1>
